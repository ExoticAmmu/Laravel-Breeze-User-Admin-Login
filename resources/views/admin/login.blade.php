...
<div class="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
    ...
    >
      ...
      <div class="p-5 bg-white md:flex-1">
        <h3 class="my-4 text-2xl font-semibold text-gray-700">Admin Account Login</h3>
        ...
        <form method="POST" action="{{ route('admin.login') }}" class="flex flex-col space-y-5">
          @csrf
          ...
          <a href="#" class="text-sm text-blue-600 hover:underline focus:text-blue-800 justify-between">Forgot Password?</a>
          </div>
          <div>
